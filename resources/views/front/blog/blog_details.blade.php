                ...
                <article class="post cmt-blog-single clearfix">
                    ...
                    <div class="cmt-post-featured-wrapper cmt-featured-wrapper mb-20">
                        <div class="cmt-post-featured">
                            <img class="img-fluid" src="{{asset('/')}}front/assets/images/blog/blog-details_06.jpg" alt="">
                        </div>
                    ...
                    <div class="cmt-blog-single-content">
                        <div class="cmt-post-entry-header">
                            <div class="post-meta">
                                ...
                                <span class="cmt-meta-line entry-date"><i class="fa fa-calendar"></i><time class="entry-date published" datetime="2018-07-28T00:39:29+00:00">July 21, 2020</time></span>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-6">
                                        <div class="ttm_single_image-wrapper mb-30 mt-20">
                                            <img class="img-fluid" src="{{asset('/')}}front/assets/images/single-img-13.jpg" alt="single_13">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <div class="cmt-blog-single-box-comment clearfix">
                            <div id="comments" class="comments-area">
                                <h2 class="comments-title">2 Replies to “Learn PHP Programming  From Scratch”</h2>
                                <ol class="comment-list">
                                    <li>
                                        <div class="comment-body">
                                            <div class="comment-author vcard">
                                                <img src="{{asset('/')}}front/assets/images/blog/b_thumbb-04-1.jpg" class="avatar" alt="comment-img">
                                            </div>
                                            <div class="comment-box">
                                                <div class="comment-meta commentmetadata">
                                                    <div class="cmt-comment-owner"><h5>Jhon Doe</h5></div>
                                                    <span>Jan 14, 2020 at 8:41 am</span>
                                                </div>
                                                <div class="reply">
                                                    <a class="cmt-btn cmt-btn-size-xs cmt-btn-shape-round cmt-btn-style-fill cmt-icon-btn-right cmt-btn-color-dark" href="#">Reply<i class="ti ti-angle-right"></i></a>
                                                </div>
                                                <div class="author-content-wrap">
                                                    <p>Seurus ornarMisl imperdiet auctor. DoPlacerat, sem mi suscipit mi, at varius enim sem at sem. Fusce tempus ex nibh, eget vulpuAenean vel consequat risus.Proin viverra</p>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="comment">
                                        <div class="comment-body">
                                            ...
                                            <div class="comment-box">
                                                <div class="comment-meta commentmetadata">
                                                    <div class="cmt-comment-owner"><h5>Jhon Doe</h5></div>
                                                    <span>Jan 14, 2020 at 8:45 am</span>
                                                </div>
                                                <div class="reply">
                                                    <a class="cmt-btn cmt-btn-size-xs cmt-btn-shape-round cmt-btn-style-fill cmt-icon-btn-right cmt-btn-color-dark" href="#">Reply<i class="ti ti-angle-right"></i></a>
                                                </div>
                                ...
                                <div class="comment-respond">
                                    ...
                                    <form action="#" method="post" novalidate="novalidate" id="commentform" class="comment-form">
                                        ...
                                        <p class="comment-form-cookies-consent">
                                            ...
                                            <label for="comment-cookies-consent" class="ml-1">Save my name, email, and website in this browser for the next time I comment.</label>
                                        </p>
                                        <p class="form-submit mt-30 mb-0 res-991-mt-15">
                                            <button class="submit cmt-btn cmt-btn-size-md cmt-btn-shape-round cmt-btn-style-fill cmt-btn-color-dark" type="submit">Post Comment</button>
                                        </p>
                                    </form>
                                </div>
                            </div>
            ...
            <div class="col-lg-4 widget-area sidebar-right cmt-col-bgcolor-yes cmt-bg cmt-right-span cmt-bgcolor-grey mt_80 pt-50 mb_80 pb-60 res-991-mt-0 res-991-pt-0">
                ...
                <aside class="widget widget-recent-post with-title">
                    ...
                    <ul class="widget-post cmt-recent-post-list">
                        <li>
                            <a href="blog-single.html"><img src="{{asset('/')}}front/assets/images/blog/b_thumbb-01-1.jpg" alt="post-img"></a>
                        ...
                        <li>
                            <a href="blog-single.html"><img src="{{asset('/')}}front/assets/images/blog/b_thumbb-02-1.jpg" alt="post-img"></a>
                            <div class="post-detail">
                        ...
                        <li>
                            <a href="blog-single.html"><img src="{{asset('/')}}front/assets/images/blog/b_thumbb-03-1.jpg" alt="post-img"></a>
                            <div class="post-detail">
                                <span class="post-date"><i class="fa fa-calendar"></i>Apr 24, 2020</span>
